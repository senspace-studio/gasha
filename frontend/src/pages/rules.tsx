...
const Rules: NextPage = () => {
  return (
    <Container color="yellow.400" maxW="xl" mb={10} fontSize="sm">
      ...
      <Text mb={6}>
        “The Ball” $CRASH Edition is an exclusive collab version of What’s in
        the Ball? with 747air.
      </Text>
      ...
      <UnorderedList mb={6}>
        ...
        <ListItem>
          Eligibility for exclusive NFT Drops, High Miles, and more TBD
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList mb={6}>
        <ListItem>
          Created from NFT sales generated by minting NFTs from
          airport.theball.fun and IRL credits at FarCon
        </ListItem>
        <ListItem>
          Any NFTs drawn after game period ends will not count towards next
          round
        </ListItem>
        <ListItem>
          Winner to be selected at random using{" "}
          <a href="https://github.com/senspace-studio/theball-lottery">
            same methodology as Season 1
          </a>
        </ListItem>
        <ListItem>
