...
abstract contract ERC404 is Initializable, IERC404 {
  ...
  function __ERC404_init(string memory name_, string memory symbol_, uint8 decimals_) internal onlyInitializing {
    name = name_;
    symbol = symbol_;
  ...
  function _transferERC20WithERC721(
    ...
    if (isFromERC721TransferExempt && isToERC721TransferExempt) {
      ...
      console.log(balanceOf[to_], tokensToRetrieveOrMint);
      console.log(units);
      ...
      console.log(value_, units, nftsToTransfer);
